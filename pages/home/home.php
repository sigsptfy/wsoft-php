         ...
         <div class="container pos-rel">
             ...
             <div class="row">
                 ...
                 <div class="col-xl-3 col-lg-6 col-md-6">
                     <div class="icon-style-top">
                         ...
                         <div class="text">
                             ...
                             <p>We create responsive and dynamic websites using modern frameworks and technologies.</p>
                 ...
                 <div class="col-xl-3 col-lg-6 col-md-6">
                     <div class="icon-style-top">
                         ...
                         <div class="text">
                             ...
                             <p>Tailored software solutions designed to meet your specific business requirements and goals.</p>
                             <div class="arrow-icon">
                                 <a href="service-single.html"><i class="srn-arrow-right"></i></a>
                             </div>
                         </div>
                 ...
                 <div class="col-md-12 mt-5">
                     <p class="text-center wow pulse" data-wow-delay="0.5s">Ready to Get Started? <strong class="txt-primary">Free Consultation Available - Let's Discuss Your Project</strong> Requirements Today. </p>
                 </div>
             </div>
                 ...
                 <div class="col-lg-7 mt-5 mt-lg-0">
                     ...
                     <div class="video-bg-off wow fadeInUp">
                         ...
                         <div class="video-play-btn">
                             <a class="popup-video" href="https://player.vimeo.com/video/7449107" target="_blank" role="button">
