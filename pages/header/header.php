                ...
                <div class="navbar-collapse offcanvas offcanvas-start offcanvas-collapse" id="navbarCollapse">
                    ...
                    <div class="offcanvas-body" data-lenis-prevent>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="our-services.html" data-bs-toggle="dropdown" aria-expanded="false">Services</a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="portfolio-2col.html" aria-expanded="false">Portfolio</a>
                                <!-- <ul class="dropdown-menu">
